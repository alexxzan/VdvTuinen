...
<section id="contact" class="bg-primary py-24">
	<div class="mx-auto max-w-7xl px-6">
		<div class="grid gap-12 lg:grid-cols-2">
			<!-- Left: Info -->
			<div>
				<h2 class="font-heading text-4xl font-bold text-offwhite">Neem Contact Op</h2>
				...
				<div class="mt-12 space-y-6">
					...
					<div class="flex items-center gap-4">
						...
						<div>
							<p class="text-sm text-gold/70">Locatie</p>
			...
			<div class="rounded-lg bg-white p-8 shadow-xl">
				...
				{:else}
					<form method="POST" use:enhance class="space-y-6">
						<div>
							<label for="name" class="block text-sm font-medium text-primary">Naam</label>
							<input
								type="text"
								id="name"
								name="name"
